...
> = {
  ...
  autoClaimInsuranceLoader: AutoClaimInsuranceLoader,
  login: LoginScreen
};
...
> = {
  ...
  chatbot: ChatBot,
  autoClaimInsurance: AutoClaimInsurance,
  autoClaimInsuranceForm: AutoClaimInsuranceForm,
  autoClaimUploadDocuments: AutoClaimUploadDocuments,
  insuranceClaimStatus: InsuranceClaimStatus,
  productSelection: ProductSelectionScreen
};
